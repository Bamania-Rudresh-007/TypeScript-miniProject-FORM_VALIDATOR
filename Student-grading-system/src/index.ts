...
function calculateAverage(score: number[]): number {
...
function assignLetterGrades(student: Student[]): Student[] {
    student.forEach((s) => {
...
function getFailingStudents(students: Student[]): Student[] {
...
function getTopStuent(student: Student[]): Student | string {
    ...
    return detail as Student;
        
}

function getGradeDistribution(student: Student[]): Record<string, number>{
